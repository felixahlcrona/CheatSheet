...
namespace HttpRequest
{
    class Program
    {
        ...
        {
            await HttpClientGetGoogleImages();
            await RestSharpGetGoogleImages();
        ...
        {
            // System.Net.Http HTTPclient. Makes a get request 
        ...
        public static async Task RestSharpGetGoogleImages()
        {
            // Makes a Restsharp GET request, generated from Postman. Uses Webclient to download image
